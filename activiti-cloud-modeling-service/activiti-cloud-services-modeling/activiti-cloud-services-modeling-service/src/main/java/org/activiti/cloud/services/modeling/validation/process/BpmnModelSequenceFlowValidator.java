...
/**
 * Implementation of {@link BpmnModelValidator} for validating Sequence flow when empty source or
 * target references are provided
 */
public class BpmnModelSequenceFlowValidator implements BpmnModelValidator {
    ...
    public Stream<ModelValidationError> validate(
        ...
        getFlowElements(bpmnModel, SequenceFlow.class)
                .forEach(
                        sequenceFlow -> {
