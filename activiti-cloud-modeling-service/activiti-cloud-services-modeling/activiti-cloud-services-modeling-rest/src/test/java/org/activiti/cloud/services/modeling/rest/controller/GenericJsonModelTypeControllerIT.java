...
public class GenericJsonModelTypeControllerIT {
    ...
    public void should_throwEmptyNameException_when_creatingGenericJsonModelWithNameEmpty()
        ...
        assertThatResponse(resultActions.andReturn())
                ...
                .hasValidationErrorMessages(
                        ...
                        "The model name should follow DNS-1035 conventions: it must consist of"
    ...
    public void should_throwTooLongNameException_when_creatingGenericJsonModelWithNameTooLong()
        ...
        assertThatResponse(resultActions.andReturn())
                ...
                .hasValidationErrorMessages(
                        ...
                        "The model name should follow DNS-1035 conventions: it must consist of"
                            + " lower case alphanumeric characters or '-', and must start and end"
                            + " with an alphanumeric character: '123456789_123456789_1234567'");
    }

    @Test
    public void should_throwBadNameException_when_creatingGenericJsonModelWithNameWithUnderscore()
            throws Exception {
        ...
        assertThatResponse(resultActions.andReturn())
                ...
                .hasValidationErrorMessages(
                        "The model name should follow DNS-1035 conventions: it must consist of"
                            + " lower case alphanumeric characters or '-', and must start and end"
                            + " with an alphanumeric character: 'name_with_underscore'");
    }

    @Test
    public void should_throwBadNameException_when_creatingGenericJsonModelWithNameWithUppercase()
            throws Exception {
        ...
        assertThatResponse(resultActions.andReturn())
                ...
                .hasValidationErrorMessages(
                        "The model name should follow DNS-1035 conventions: it must consist of"
                            + " lower case alphanumeric characters or '-', and must start and end"
                            + " with an alphanumeric character: 'NameWithUppercase'");
    }
    ...
    @Test
    public void should_throwBadNameException_when_updatingGenericJsonModelWithNameWithUnderscore()
            throws Exception {
        String name = "name_with_underscore";
    ...
    @Test
    public void should_throwBadNameException_when_updatingGenericJsonModelWithNameWithUppercase()
            throws Exception {
        String name = "NameWithUppercase";
