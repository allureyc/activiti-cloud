...
public interface ModelRestApi {
    ...
    PagedModel<EntityModel<Model>> getModels(
        @ApiParam(
            value = GET_MODELS_PROJECT_ID_PARAM_DESCR,
            required = true
        ) @PathVariable String projectId,
        @ApiParam(GET_MODELS_TYPE_PARAM_DESCR) @RequestParam(
    ...
    EntityModel<Model> getModel(
        @ApiParam(
            value = GET_MODEL_ID_PARAM_DESCR,
            required = true
    ...
    EntityModel<Model> createModel(
        @ApiParam(
            value = CREATE_MODEL_PROJECT_ID_PARAM_DESCR,
            required = true
        ) @PathVariable String projectId,
    ...
    EntityModel<Model> updateModel(
        @ApiParam(
            value = UPDATE_MODEL_ID_PARAM_DESCR,
            required = true
        ) @PathVariable String modelId,
    ...
    void updateModelContent(
        ...
        @ApiParam(UPDATE_MODEL_FILE_PARAM_DESCR) @RequestPart(
    ...
    void deleteModel(
        @ApiParam(
            value = DELETE_MODEL_ID_PARAM_DESCR,
            required = true
        ) @PathVariable String modelId
    );
    ...
    void getModelContent(
        ...
        @ApiParam(
            value = GET_MODEL_CONTENT_ID_PARAM_DESCR,
            required = true
        ) @PathVariable String modelId
    ) throws IOException;
    ...
    EntityModel<Model> importModel(
        ...
        @ApiParam(IMPORT_MODEL_TYPE_PARAM_DESCR) @RequestParam(
            MODEL_TYPE_PARAM_NAME
        ) String type,
        @ApiParam(IMPORT_MODEL_FILE_PARAM_DESCR) @RequestPart(
            UPLOAD_FILE_PARAM_NAME
        ) MultipartFile file
    ) throws IOException;
    ...
    void exportModel(
        HttpServletResponse response,
        @ApiParam(
            value = EXPORT_MODEL_ID_PARAM_DESCR,
            required = true
        ) @PathVariable String modelId,
        @ApiParam(ATTACHMENT_API_PARAM_DESCR) @RequestParam(
    ...
    void validateModel(
        @ApiParam(
            value = VALIDATE_MODEL_ID_PARAM_DESCR,
            required = true
        ) @PathVariable String modelId,
        @ApiParam(VALIDATE_MODEL_FILE_PARAM_DESCR) @RequestParam(
            UPLOAD_FILE_PARAM_NAME
        ) MultipartFile file,
        @ApiParam(
            value = VALIDATE_PROJECT_ID_PARAM_DESCR,
            required = false
        ) @RequestParam(
    ...
    void validateModelExtensions(
        ...
        @ApiParam(VALIDATE_EXTENSIONS_FILE_PARAM_DESCR) @RequestParam(
            UPLOAD_FILE_PARAM_NAME
        ) MultipartFile file,
        @ApiParam(
            value = VALIDATE_PROJECT_ID_PARAM_DESCR,
    ...
    PagedModel<EntityModel<Model>> getGlobalModels(
        ...
        @ApiParam(
            value = INCLUDE_ORPHANS_PARAM_DESCR,
            required = false
        ) @RequestParam(
    ...
    EntityModel<Model> putProjectModelRelationship(
        @ApiParam(
            value = RELATE_MODEL_PROJECT_PROJECT_ID_PARAM_DESCR,
            required = true
        ) @PathVariable String projectId,
        @ApiParam(
            value = RELATE_MODEL_PROJECT_MODEL_ID_PARAM_DESCR,
            required = true
        ) @PathVariable String modelId,
        @ApiParam(value = SCOPE_PARAM_DESCR, required = false) @RequestParam(
            value = SCOPE_PARAM_NAME,
            required = false
        ) String scope,
        @ApiParam(value = FORCE_PARAM_DESCR, required = false) @RequestParam(
