...
public interface ProjectRestApi {
    ...
    PagedModel<EntityModel<Project>> getProjects(
        Pageable pageable,
        @ApiParam(PROJECT_NAME_PARAM_DESCR) @RequestParam(
    ...
    EntityModel<Project> getProject(
        @ApiParam(
            value = GET_PROJECT_ID_PARAM_DESCR,
            required = true
    ...
    EntityModel<Project> updateProject(
        @ApiParam(
            value = UPDATE_PROJECT_ID_PARAM_DESCR,
            required = true
        ) @PathVariable String projectId,
    ...
    void deleteProject(
        @ApiParam(
            value = DELETE_PROJECT_ID_PARAM_DESCR,
            required = true
        ) @PathVariable String projectId
    );
    ...
    EntityModel<Project> importProject(
        @ApiParam(IMPORT_PROJECT_FILE_PARAM_DESCR) @RequestParam(
            UPLOAD_FILE_PARAM_NAME
        ) MultipartFile file,
        @ApiParam(PROJECT_NAME_OVERRIDE_DESCR) @RequestParam(
            name = PROJECT_NAME_PARAM_NAME,
            required = false
        ) String name
    ) throws IOException;
    ...
    void exportProject(
        ...
        @ApiParam(
            value = EXPORT_PROJECT_ID_PARAM_DESCR,
            required = true
        ) @PathVariable String projectId,
    ...
    EntityModel<Project> copyProject(
        @ApiParam(
            value = COPY_PROJECT_ID_PARAM_DESCR,
            required = true
        ) @PathVariable String projectId,
        @ApiParam(value = PROJECT_NAME_COPY_DESCR) @RequestParam(
            name = PROJECT_NAME_PARAM_NAME
        ) String name
    );
