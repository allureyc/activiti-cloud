...
public class ModelImpl
    ...
    @ApiModelProperty(
        value = "The content type of the model",
        readOnly = true,
        hidden = true
    )
    ...
    @ApiModelProperty(
        value = "The content of the model",
        readOnly = true,
        hidden = true
    )
    ...
    @ApiModelProperty(
        value = "The scope of the model. They can be shared between projects if it's scope is GLOBAL",
        readOnly = true
    )
