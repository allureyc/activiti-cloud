...
public class ServiceTaskIntegrationResultEventHandlerTest {
    ...
    public void setUp() {
        ...
        when(messageBuilderFactory.create(any()))
            .thenReturn(new MessageBuilderAppenderChain());
        ...
        given(commandContext.getExecutionEntityManager().findById(anyString()))
            .willReturn(executionEntity);

        given(managementService.executeCommand(any()))
    ...
    public void receive_should_setVariablesTriggerExecutionAndDeleteRelatedIntegrationContext() {
        ...
        verify(executionEntity)
            .setVariableLocal("var1", variables.get("var1"), false);
    ...
    public void receiveShouldDoNothingWhenIntegrationContextsIsNull() {
        ...
        given(executionQuery.list())
            .willReturn(Collections.singletonList(mock(Execution.class)));
        Map<String, Object> variables = Collections.singletonMap("var1", "v");
    ...
    public void receiveShouldSendIntegrationAuditEventWhenIntegrationAuditEventsAreEnabled() {
        ...
        assertThat(event.getEntity().getProcessInstanceId())
            .isEqualTo(PROC_INST_ID);
        assertThat(event.getEntity().getProcessDefinitionId())
            .isEqualTo(PROC_DEF_ID);
    ...
    public void retrieveShouldNotSentAuditEventWhenIntegrationAuditEventsAreDisabled() {
        ...
        IntegrationResultImpl integrationResultEvent = new IntegrationResultImpl(
            new IntegrationRequestImpl(),
            integrationContext
        );
        ...
        //then
        verify(processEngineEventsAggregator, never())
            .add(any(CloudRuntimeEvent.class));
    }
}
