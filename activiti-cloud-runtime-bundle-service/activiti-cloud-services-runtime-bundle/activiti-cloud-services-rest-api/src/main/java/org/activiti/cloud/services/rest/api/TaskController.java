...
public interface TaskController {
    ...
    @PostMapping(value = "/{taskId}/complete", headers = "Content-type=application/json")
    EntityModel<CloudTask> completeTask(
            @PathVariable(value = "taskId") String taskId,
            @RequestBody CompleteTaskPayload completeTaskPayload);

    @PostMapping(value = "/{taskId}/save", headers = "Content-type=application/json")
    void saveTask(
            @PathVariable(value = "taskId") String taskId,
    ...
    @PutMapping(value = "/{taskId}", headers = "Content-type=application/json")
    ...
    @PostMapping(value = "/{taskId}/assign", headers = "Content-type=application/json")
