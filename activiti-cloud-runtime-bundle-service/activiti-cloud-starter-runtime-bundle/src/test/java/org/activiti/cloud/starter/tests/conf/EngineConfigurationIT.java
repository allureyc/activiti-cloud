...
public class EngineConfigurationIT {
    ...
    public void shouldHaveChannelBindingsSetForMessageEvents() {
        ...
        assertProperty("spring.cloud.stream.bindings.messageEvents.producer.required-groups")
                .isEqualTo("messages");
    }
    ...
    public void shouldHaveChannelBindingsSetForCommandEndpoint() {
        // when
        assertProperty("spring.cloud.stream.bindings.commandConsumer.destination")
        ...
        assertProperty("spring.cloud.stream.bindings.commandResults.destination")
    ...
    public void shouldHaveChannelBindingsSetForSignalEvents() {
        // when
        assertProperty("spring.cloud.stream.bindings.signalProducer.destination")
                .isEqualTo("signalEvent");
        assertProperty("spring.cloud.stream.bindings.signalProducer.producer.required-groups")
                .isEqualTo("my-activiti-rb-app");
        assertProperty("spring.cloud.stream.bindings.signalConsumer.destination")
                .isEqualTo("signalEvent");
    ...
    public void shouldHaveChannelBindingsSetForCloudConnectors() {
        // when
        assertProperty("spring.cloud.stream.bindings.integrationResultsConsumer.destination")
                .isEqualTo("integrationResult.my-activiti-rb-app");
        assertProperty("spring.cloud.stream.bindings.integrationResultsConsumer.group")
                .isEqualTo("my-activiti-rb-app");
        assertProperty("spring.cloud.stream.bindings.integrationErrorsConsumer.destination")
                .isEqualTo("integrationError.my-activiti-rb-app");
        assertProperty("spring.cloud.stream.bindings.integrationErrorsConsumer.group")
                .isEqualTo("my-activiti-rb-app");
    }
