...
public class BPMNSequenceFlowTakenEventHandler implements QueryEventHandler {
    ...
    public BPMNSequenceFlowTakenEventHandler(
        BPMNSequenceFlowRepository activitiyRepository,
    ...
    public void handle(CloudRuntimeEvent<?, ?> event) {
        ...
        BPMNSequenceFlowEntity bpmnSequenceFlowEntity = bpmnSequenceFlowRepository.findByEventId(
            event.getId()
        );
        ...
        if (bpmnSequenceFlowEntity == null) {
            ...
            bpmnSequenceFlowEntity.setElementId(
                bpmnSequenceFlow.getElementId()
            );
            ...
            bpmnSequenceFlowEntity.setDate(
    ...
    private void persistIntoDatabase(
        ...
        try {
            ...
            throw new QueryException(
                "Error handling CloudSequenceFlowTakenEvent[" + event + "]",
                cause
            );
        }
    }
